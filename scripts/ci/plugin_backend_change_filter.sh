...
# zeroclaw-channels is listed because the shared inbound dispatcher now owns
# the typed plugin event queue behind its own plugins-wasm feature: a change
# there can break the plugin backend job while nothing under
# crates/zeroclaw-plugins moves.
