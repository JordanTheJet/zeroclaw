...
| --- | --- | --- |
| `src/cron` | [ADR-016](../../docs/book/src/architecture/decisions/ADR-016-cron-extraction-and-transitional-exception.md), tracked by [#10546](https://github.com/zeroclaw-labs/zeroclaw/issues/10546) | when `zeroclaw-cron` lands, or on Core Team withdrawal |
