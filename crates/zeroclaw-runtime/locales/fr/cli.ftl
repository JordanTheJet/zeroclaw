...
cli-enroll-frontdoor-header = Ou inscrivez un téléphone dans son navigateur via le relais (si le relais sert la page d’inscription) - scannez ou ouvrez :
cli-enroll-frontdoor-link = {"    "}lien         : {$link}
