...
cli-enroll-frontdoor-header = O inscribe un teléfono en su navegador a través del relay (si el relay sirve la página de inscripción): escanea o abre:
cli-enroll-frontdoor-link = {"    "}enlace       : {$link}
