...
#[cfg(not(test))]
fn validate_resolved_host_is_public(host: &str, allow_private: bool) -> anyhow::Result<()> {
...
#[cfg(test)]
fn validate_resolved_host_is_public(_host: &str, _allow_private: bool) -> anyhow::Result<()> {
