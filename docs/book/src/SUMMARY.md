...
- [Architecture](./architecture/overview.md)
  ...
  - [Control MCP protocol v1](./architecture/control-plane-mcp-protocol-v1.md)
  - [Control-plane trust genesis](./architecture/control-plane-trust-genesis.md)
  - [Control-plane principals and approvals](./architecture/control-plane-principals-and-approvals.md)
  - [Control-plane proposal journal](./architecture/control-plane-proposal-journal.md)
