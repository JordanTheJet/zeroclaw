...
flowchart TB
    ...
    subgraph Core["Core"]
        ONB["zeroclaw-control<br/>Zerona proposal · preview · validation"]
...
| `zeroclaw-control` | Capability-free Zerona conversation, narrow agent proposal validation, and host-renderable preview |
